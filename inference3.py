...
if __name__ == '__main__':
    ...
    for image_path in glob.glob(osp.join('datasets/total_text/test_images', '*.jpg')):
        ...
        #visualizar
        #cv2.imshow('Logo OpenCV Grises',bitmap)
        print('bitmap')
        print('tamaño bitmap ' + str(len(bitmap)))
        ...
        I = Image.open("/content/datasets/total_text/test_images/Starbucks-Logo.jpg")
        I.show()
        ...
        #cv2.imwrite('test/' + image_fname, bitmap)
        #visualizar la imagen de bitmap, ver que corresponda con el texto, erosion y dilatacion y aplicarla a la imagen original
        #invertir la mascara con opencv con el bitmap
